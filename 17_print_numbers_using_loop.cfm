...
<body>
    ...
    <div class=" p-5  text-center ">
        ...
        <cfloop from="1" to="#form.number#" index="i">
             <cfset myComponent=createObject("component","cfc/17_print_numbers_using_loop")>
        <cfset result =myComponent.evenOrOdd(i)>



                <cfif result is true>

                   <span class="text-success fs-2"> <cfoutput>#i# </cfoutput></span>
