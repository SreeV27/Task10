...
<html lang="en">
   ...
   <body>
      <div class=" pt-5 text-center">
         ...
         <form action="14_Upload_validation_and_Image_function.cfm" method="post" class="mt-5 border p-4" enctype="multipart/form-data" onsubmit="validateImage()">
         ...
         <cfinvoke component="cfc/14_Upload_validation_and_Image_function" method="imageValidation">
            ...
            <cfinvokeargument name="imagePath" value="#uploadedFileName#">
         </cfinvoke>
         </cfif>
      </div>
   </body>
